...
class Segnet_unet(nn.Module):
    def __init__(self,input_nbr,label_nbr):
       ...
       #模块2
        ...
        self.conv52d = nn.Conv2d(512, 1024, kernel_size=3, padding=1)
        self.bn52d = nn.BatchNorm2d(1024, momentum=0.1)
        ...
        self.conv42d = nn.Conv2d(512, 1024, kernel_size=3, padding=1)
        self.bn42d = nn.BatchNorm2d(1024, momentum=0.1)
        self.conv41d = nn.Conv2d(1024, 256, kernel_size=3, padding=1)
...
model = Segnet_unet(input_nbr=3,label_nbr=5)
...
#      print(miou[0])
#      with open('./result/u_segnet.txt','a',encoding='utf-8') as f:
#          f.writelines(img_index+""+'acc '+str(acc)+" "+'class_acc '+str(np.mean(class_acc))+" "+"iou[{},{},{},{},{}] ".format(miou[0],miou[1],miou[2],miou[3],miou[4])+" "+"miou "+str(np.mean(miou))+"fiou "+str(fiou))
#
